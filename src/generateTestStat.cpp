/* Generate AMKAT observed test statistic with feature selection and kernel
 * selection results
...
// [[Rcpp::export]]
Rcpp::List generateTestStat(const arma::mat& y,
  ...
  uvec selected_x_columns = applyAmkatFilter(y, x);
