 ...
 *  - function name changed from 'prho' to 'computeTailAreaSpearmanRho'
 ...
 *  - removed the wrapper function 'pRho' used to call prho from R
 */
 ...
 */
void
  computeTailAreaSpearmanRho(int n, double is, int ifault, int lower_tail,
                             double* pv)
  {
